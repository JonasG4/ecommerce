...
-- Tiempo de generación: 20-10-2022 a las 03:24:37
...
CREATE TABLE IF NOT EXISTS `tbl_clientes` (
  ...
  KEY `FK_cliente_direcciones` (`id_direcciones`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbl_cliente_direcciones`
--

DROP TABLE IF EXISTS `tbl_cliente_direcciones`;
CREATE TABLE IF NOT EXISTS `tbl_cliente_direcciones` (
...
CREATE TABLE IF NOT EXISTS `tbl_municipios` (
  ...
  KEY `ad_mu_relacion` (`id_departamento`),
  KEY `ad_mu_relacion_2` (`id_departamento`),
  KEY `ad_mu_relacion_3` (`id_departamento`)
...
--
-- Estructura de tabla para la tabla `tbl_pacientes_vacunas`
--

DROP TABLE IF EXISTS `tbl_pacientes_vacunas`;
CREATE TABLE IF NOT EXISTS `tbl_pacientes_vacunas` (
...
--
-- Volcado de datos para la tabla `tbl_pacientes_vacunas`
--
...
CREATE TABLE IF NOT EXISTS `tbl_productos` (
  ...
  KEY `user_ing` (`user_ing`),
  KEY `user_mod` (`user_mod`),
  KEY `fk_producto_imagenes` (`id_imagenes`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbl_producto_imagenes`
--

DROP TABLE IF EXISTS `tbl_producto_imagenes`;
CREATE TABLE IF NOT EXISTS `tbl_producto_imagenes` (
...
--
-- Volcado de datos para la tabla `tbl_representantes`
--
...
ALTER TABLE `tbl_clientes`
  ADD CONSTRAINT `FK_cliente_direcciones` FOREIGN KEY (`id_direcciones`) REFERENCES `tbl_cliente_direcciones` (`id_direccion`);

--
-- Filtros para la tabla `tbl_cliente_direcciones`
--
ALTER TABLE `tbl_cliente_direcciones`
  ADD CONSTRAINT `FK_cliente` FOREIGN KEY (`id_cliente`) REFERENCES `tbl_clientes` (`id_cliente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_departamento` FOREIGN KEY (`id_departamento`) REFERENCES `tbl_departamentos` (`id_departamento`),
...
--
-- Filtros para la tabla `tbl_pacientes_vacunas`
--
...
ALTER TABLE `tbl_productos`
  ADD CONSTRAINT `fk_producto_imagenes` FOREIGN KEY (`id_imagenes`) REFERENCES `tbl_producto_imagenes` (`id_imagen`),
...
--
-- Filtros para la tabla `tbl_producto_imagenes`
--
ALTER TABLE `tbl_producto_imagenes`
  ADD CONSTRAINT `FK_producto` FOREIGN KEY (`id_producto`) REFERENCES `tbl_productos` (`id_producto`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Filtros para la tabla `tbl_representantes`
--
