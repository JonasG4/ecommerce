    ...
    <div class="col-md-12">
        <div class="card card-primary">
            ...
            <div class="card-body">
                <table class="table table-sm table-striped table-hover table-bordered">
                    <tr>
                        ...
                        <td width="34%"><span class="badge bg-<?= $model->visible == 1 ? "green" : "red"; ?>"><?= $model->visible == 1 ? "Activo" : "Inactivo"; ?></span></td>
                    </tr>
                    <tr>
            ...
            <div class="card-footer">
                <?php echo Html::a('<i class="fa fa-edit"></i> Editar', ['update', 'id_especie' => $model->id_especie], ['class' => 'btn btn-primary', 'data-toggle' => 'tooltip', 'title' => 'Edit record']) ?>
