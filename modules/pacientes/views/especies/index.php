...
$this->title = 'Listado de especies';
            ...
            $gridColumns = [
                ...
                [
                    ...
                    'value' => function ($model, $key, $index, $widget) {
                        return Html::tag('span', $model->id_especie, ['class' => 'badge bg-purple']);
                    },
                    'filter' => false,
                ],
                [
                    ...
                    'format' => 'html',
                    'value' => function ($model, $key, $index, $widget) {
                        return Html::a($model->nombre,  ['view', 'id_especie' => $model->id_especie]);
                    },
                    'filterType' => GridView::FILTER_SELECT2,
                    'filter' => ArrayHelper::map(TblEspecies::find()->orderBy('nombre')->all(), 'nombre', 'nombre'),
                    'filterWidgetOptions' => [
